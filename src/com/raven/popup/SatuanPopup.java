 ...
 * @author rayag
 */
public class SatuanPopup extends javax.swing.JPanel {
    ...
    private void saveData() {
        try {
            ...
            if (!nama.isEmpty()) {
                if (isEditMode) {
                    // UPDATE 
                    String query = "UPDATE satuan SET satuan = ? WHERE kode_satuan = ?";
                    PreparedStatement ps = con.prepareStatement(query);
                    ps.setString(1, nama);
                    ps.setString(2, editKodeSatuan);
                    ps.executeUpdate();

                    JOptionPane.showMessageDialog(null, "Data berhasil diupdate!");
                } else {
                    // INSERT
                    String query = "INSERT INTO satuan (satuan) VALUES (?)";
                    PreparedStatement ps = con.prepareStatement(query);
                    ps.setString(1, nama);
                    ps.execute();
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelRound1Layout.createSequentialGroup()
                ...
                .addGroup(panelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtNama, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 298, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(30, 30, 30))
        );
